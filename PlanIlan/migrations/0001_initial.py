# Generated by Django 3.1.5 on 2021-01-05 22:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('semester', models.IntegerField(choices=[(1, "סמסטר א'"), (2, "סמסטר ב'"), (3, "סמסטר ק'"), (4, 'שנתי')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.IntegerField(choices=[(0, 'ד"ר'), (1, "פרופ'"), (2, 'מר'), (3, 'גברת'), (4, 'הרב'), (5, 'עו"ד'), (6, 'השופט'), (-1, '')])),
        ...
        migrations.AddField(
            model_name='course',
            name='teacher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='PlanIlan.teacher'),
        ),
    ]
