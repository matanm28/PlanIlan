# Generated by Django 3.1.5 on 2021-04-13 16:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_faculty', models.IntegerField(choices=[(0, 'כללי'), (1, 'מדעי החיים '), (2, 'מדעי היהדות'), (3, 'משפטים'), (4, 'רפואה'), (5, 'מדעי החברה'), (6, 'הנדסה '), (7, 'מדעים מדויקים'), (8, 'יחידה ללימודים בין תחומיים'), (9, 'מדעי הרוח'), (10, 'לא ידוע')], db_column='faculty')),
                ('phone', models.CharField(max_length=12, null=True)),
                ('email', models.EmailField(max_length=254, null=True)),
                ('office', models.CharField(max_length=100, null=True)),
                ('website_url', models.URLField(null=True)),
                ('image', models.ImageField(null=True, upload_to=PlanIlan.models.teacher.user_directory_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.IntegerField(choices=[(0, 'כללי'), (1, 'מדעי החיים '), (2, 'מדעי היהדות'), (3, 'משפטים'), (4, 'רפואה'), (5, 'מדעי החברה'), (6, 'הנדסה '), (7, 'מדעים מדויקים'), (8, 'יחידה ללימודים בין תחומיים'), (9, 'מדעי הרוח'), (10, 'לא ידוע')], db_column='faculty')),
                ('teachers', models.ManyToManyField(related_name='faculties', to='PlanIlan.Teacher')),
            ],
            options={
                'abstract': False,
            },
