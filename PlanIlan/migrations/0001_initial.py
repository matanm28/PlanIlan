    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('faculty', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='PlanIlan.faculty')),
                ('rating', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='PlanIlan.rating')),
            ],
        ),
        migrations.CreateModel(
            name='UserModel',
        ...
        migrations.AddField(
            model_name='teacher',
            name='title',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='PlanIlan.title'),
        ),
        migrations.CreateModel(
            name='SessionTime',
            fields=[
                ...
                ('day', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='PlanIlan.day')),
                ('semester', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='PlanIlan.semester')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='PlanIlan.lessontype')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='PlanIlan.examperiod')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='course',
            name='department',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='PlanIlan.department'),
        ),
        migrations.AddField(
            model_name='course',
            name='exams',
            field=models.ManyToManyField(to='PlanIlan.Exam'),
        ),
        migrations.AddField(
            model_name='course',
            name='faculty',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='PlanIlan.faculty'),
        ),
        migrations.AddField(
            model_name='course',
            name='rating',
